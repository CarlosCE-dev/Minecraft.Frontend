...
export default {
    ...
    ErrorCreateGroup: 'Ocurrió un error al intentar crear el nuevo evento',
    ErrorWhenDeleteEvent: 'Ocurrió un error al intentar eliminar el evento.',
    ErrorWhenDeleteReward: 'Ocurrió un error al intentar eliminar el premio.',
    ErrorWhenEventDetails: "Ocurrió un error al intentar obtener los detalles del evento.",
    ErrorWhenGetReward: "Ocurrió un error al intentar obtener tu premio.",
    ErrorWhenLoadingRewardsSelected: 'Ocurrió un error al intentar obtener los premios de este evento.',
    ErrorWhenLoadingRouletteData: 'Ocurrió un error al intentar obtener la información de la ruleta',
    ErrorWhenLoadingRouletteHistory: "Ocurrió un error al intentar obtener el historial de la ruleta",
    ErrorWhenLoadingRoulettes: 'Ocurrió un error al intentar obtener las ruletas disponibles',
    ErrorWhenObtainingEvents: 'Ocurrió un error al intentar obtener la lista de eventos.',
    ErrorWhenObtainingHistory: "Ocurrió un error al obtener tu historial de ganancias.",
    ErrorWhenObtainingMoney: "Ocurrió un error al obtener tus Pejecoins.",
    ErrorWhenObtainingRewardHistory: "Ocurrió un erro al obtener tu historial de premios reclamados.",
    ErrorWhenObtainingRewards: 'Ocurrió un error al intentar obtener la lista de premios',
    ErrorWhenObtainingUsersOnline: "Ocurrió un error al intentar obtener los usuarios online.",
    ErrorWhenPasswordUpdate: "Se produjo un error al intentar cambiar la contraseña de tu usuario.",
    ErrorWhenSavingRewardsOfEvent: 'Ocurrió un error al intentar guardar los premios de este evento.',
    ErrorWhenStatusEvent: "Ocurrió un error al intentar cambiar el status actual del evento.",
    ErrorWhenUploadingImage: 'Ocurrió un error al intentar crear el nuevo premio',
    ErrorWhenUserRewards: "Ocurrió un error al intentar obtener los premios de tu usuario.",
    ErrorWhenVerifyMoney: 'Ocurrió un error al intentar verificar tu billetera.',
    ...
    MoneyHistoryRoulette: "Gastaste {amount} Pejecoins en la ruleta por el premio {title}",
    Name: "Nombre",
    ...
    Play: "Jugar",
    Price: "Precio",
    PrizePerGift: "Precio por juego:",
    ProcessingPrize: "Procesando premio",
    Rare: "Rareza",
    Register: "Registro",
    Restart: "Reiniciar",
    ...
    Roulette: "Ruleta",
    RouletteAvailable: "Ruletas disponibles",
    RouletteInfo: "Juega suerte tirando en las ruletas que se encuentran disponibles",
