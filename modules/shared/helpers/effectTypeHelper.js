...
const descriptionTextHelper = {
    ...
    [EffectTypes.slow_falling]: "Decreases falling speed and negates fall damage",
    [EffectTypes.conduit_power]: "Increases underwater visibility and mining speed, prevents drowning",
    [EffectTypes.dolphins_grace]: "Increases swimming speed (only obtainable from dolphins)",
